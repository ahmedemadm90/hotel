    ...
    <div class="col-md-12 w-75 m-auto">
        <div class="card ">
            <div class="card-header card-header-rose card-header-icon">
                <h4 class="card-title">{{ 'file.New Order' }}</h4>
            </div>
            <div class="card-body ">
                <form class="form" method="POST" action="{{ route('orders.store') }}"
                        ...
                        <div class="col-md">
                            ...
                            <select class="select-reservation w-100" name="reservation_id">
                                ...
                                @foreach (App\Models\Reservation::where('state', 'active')->get() as $reservation)
                                    <option value="{{ $reservation->id }}">{{ $reservation->room->room_no }} ||
                                ...
                                <div class="row m-3" id="selectType">
                                    ...
                                    <div class="col-md">
                                        ...
                                        <select class="form-select form-control w-100" name="types[]">
                                            <option value="" disabled hidden selected>{{('file.Select Type')}}</option>
                    ...
                    <div class="row m-2">
                        <div class="col-md">
                            ...
                            <textarea cols="50" rows="5" class="form-control" id="note" name="note"></textarea>
                        </div>
                    </div>
                    <hr>
                    <div class="row m-2">
